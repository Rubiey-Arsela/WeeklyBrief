...
const t0 = Date.now()
const r = await processFile('Maida Vale - Weekly Brief - 20260703.pdf')
console.log('TOTAL ELAPSED:', Date.now()-t0, 'ms')
console.log('label:', r.label)
console.log('exec_summary len:', r.exec_summary.length)
console.log('speed_read:', r.speed_read.length)
console.log('structural:', r.structural.slice(0,100))
console.log('pulse rows:', r.pulse.length)
console.log('items:', r.items.length)
console.log('watchlist:', r.watchlist.length)
fs.writeFileSync('/tmp/full_result.json', JSON.stringify(r, null, 2))
